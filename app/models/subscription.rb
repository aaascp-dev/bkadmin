class Subscription < ApplicationRecord
    ...
    validates :client, presence: { message: "Cliente deve ser informado." }
    validates :plan,  presence: { message: "Plano deve ser informado." }
    validates :start_date, presence:{ message: "Data de início deve ser informada." }
